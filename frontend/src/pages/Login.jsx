            ...
            >
                ...
                <motion.div
                    ...
                    style={{
                        ...
                        boxShadow: '0 4px 16px rgba(168, 85, 247, 0.04)',
                    }}
                >
                    {}
                    <div className="flex items-center justify-between mb-3">
                        <h3
                            className="text-sm font-medium text-gray-600 text-center flex-1"
                        ...
                        <motion.button
                            ...
                            style={{
                                background: showDemoCredentials
                                    ? 'rgba(168, 85, 247, 0.15)'
                                    : 'rgba(156, 163, 175, 0.1)',
                                border: showDemoCredentials
                                    ? '1px solid rgba(168, 85, 247, 0.3)'
                                    : '1px solid rgba(156, 163, 175, 0.2)',
                            }}
                            title={showDemoCredentials ? 'Hide credentials' : 'Show credentials'}
                        >
                            {showDemoCredentials ? '👁️' : '👁️‍🗨️'}
                        </motion.button>
                    </div>
                    ...
                    <AnimatePresence mode="wait">
                        {showDemoCredentials ? (
                            ...
                            >
                                {[
                                    { role: 'Super Admin', username: 'superadmin', password: 'admin123', emoji: '👑' },
                                    { role: 'College Admin', username: 'collegeadmin', password: 'admin123', emoji: '🏫' },
                                    { role: 'Faculty', username: 'faculty', password: 'faculty123', emoji: '👨‍🏫' },
                                    { role: 'Student', username: 'student', password: 'student123', emoji: '🎓' },
                                ].map((cred, index) => (
                                    <motion.button
                                        key={index}
                                        onClick={() => {
                                    ...
                                    >
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <div>
                                                    <div className="font-medium text-gray-700" style={{ fontWeight: 500 }}>
                                                        {cred.role}
                                                    </div>
                                                    <div className="text-gray-500 font-mono" style={{ fontSize: '10px' }}>
                            ...
                            >
                                ...
                                <p
                                    ...
                                    style={{ fontFamily: "'Inter', system-ui, sans-serif", fontWeight: 300 }}
                                >
                                    Click the eye icon to reveal test credentials
                                </p>
                            </motion.div>
                        )}
                    </AnimatePresence>
